...
// 4. Делегування: підсвічування списків
...
// 5. Меню "Тренування" з патерном Поведінка (тепер з візуальними змінами)
function initMenu() {
...
function initAdvancedHandlers() {
    ...
    // Через 8 секунд видаляємо обробник і візуально міняємо кнопку
    setTimeout(() => {
...
// Запуск (перевірка, щоб не запускати блоки всередині фреймів)
if (window.self === window.top) {
